...
class SawtoothGenerator:
    ...
    """
    def __init__(self, maxval, minval, period, *args, **kwargs):
        self.maxval = maxval
        self.minval = minval
        self.period = period
        self.time = None
    ...
    def generate(self, end_time, sample_period):
        """
        Function to return a Sawtooth waveform as a timeseries, returned as a numpy array

        Parameters
        -----------
        end_time: `double`
            End time in seconds of the sawtooth waveform
